...
export default function SetPasswordPage() {
  ...
  useEffect(() => {
    if (!token) {
      setError('Link je nevažeći. Molimo zatražite novi link za postavljanje lozinke.')
    }
  }, [token])
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast.success('Lozinka uspješno sačuvana. Možete se prijaviti.')
      ...
      setError('Link je nevažeći ili je istekao. Molimo zatražite novi.')
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-900 to-primary-700 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Postavljanje lozinke</h2>
