...
export default function ActivatePage() {
  ...
  useEffect(() => {
    if (!token) {
      setError('Link je nevažeći. Molimo kontaktirajte administratora.')
    }
  }, [token])
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast.success('Nalog je aktiviran. Možete se prijaviti.')
      ...
      setError('Link je nevažeći ili je istekao. Molimo kontaktirajte administratora.')
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-900 to-primary-700 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Aktivacija naloga</h2>
